...
//               <ul className="absolute top-full left-0 w-250 bg-[#9969C7] rounded-lg shadow-lg mt-2 py-1 px-4 grid grid-cols-11 gap-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
//               {brands.map((brand, index) => (
//                   <li key={index}>
//                     <Link to={`/products/${brand.toLowerCase()}`} className="block text-white py-2 px-2 hover:bg-[#a10cb5]">
//                       {brand}
//                     </Link>
//                   </li>
...
//             <input type="text" placeholder="Search..." className="w-48 px-4 py-2 rounded-lg border-2 border-white text-white placeholder-gray-300 focus:outline-none focus:ring-2" />
//           </div>
...
//             </svg>
//           </Link>
//           <Link to="/quote" className="bg-white text-purple-700 py-1 px-3 rounded-lg hover:bg-purple-700 hover:text-white transition-all duration-300">Get A Quote</Link>
//           <Link to="/track" className="bg-purple-700 text-white py-1 px-3 rounded-lg hover:bg-white hover:text-purple-700 transition-all duration-300">Track Progress</Link>
//           {/* Hamburger Menu */}
...
//           <input type="text" placeholder="Search..." className="w-full px-4 py-2 rounded-lg border border-white text-white placeholder-gray-400 focus:outline-none focus:ring-2" />
//           <ul className="mt-2">
...
//             <li>
//               <button onClick={() => setIsMobileCategoriesOpen(!isMobileCategoriesOpen)} className="block w-full text-left text-white py-2 px-4 hover:bg-[#81639d98]">Brands</button>
//               {isMobileCategoriesOpen && (
//                 <ul className="ml-4 mt-1 rounded-lg shadow-lg py-2 bg-purple-400">
//                   {brands.map((brand, index) => (
//                     <li key={index}>
//                       <Link to={`/products/${brand.toLowerCase()}`} className="block text-white py-2 px-4 hover:bg-[#81639d98]">
//                         {brand}
//                       </Link>
//                     </li>
//                   ))}
